...
public class Home extends JFrame {
    ...
    private void initComponents() {
        ...
        tablaComunidades.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                if (tablaComunidades.getSelectedRow() != -1) {
                    ...
                    if (selectedRow != -1) {
                        codAutonomia = autonomias.stream().filter(aut -> aut.getNombreCircunscripcion().equals(((String) tablaComunidades.getValueAt(selectedRow, 0)))).findFirst().get().getCodigo();
        ...
        btnCongresoSondeo.setText("SONDEO MUNICIPALES");
        ...
        btnDatosSenado.setText("DATOS AUTONOMICAS");
        ...
        btnDatosCongreso.setText("DATOS MUNICIPALES");
